...
export default function CreateABet() {
    ...
    let [allBetsLines, setAllBetsLines] = useState([]),
        ...
        [availableMargin, setAvailableMargin] = useState(0)
    ...
    const {
        ...
        data: WDdata,
        isLoading: WDisLoading,
        isFetching: WDisFetching,
    } = useWeb3Contract({
        abi: abi,
        contractAddress: cryptocurrencyFutureBetAddress,
        functionName: "withDraw",
        params: { amount: availableMargin },
    })
    ...
    const {
        ...
        data: BWdata,
        isLoading: BWisLoading,
        isFetching: BWisFetching,
    } = useWeb3Contract({
        abi: abi,
        contractAddress: cryptocurrencyFutureBetAddress,
    ...
    const {
        ...
        data: BMdata,
        isLoading: BMisLoading,
        isFetching: BMisFetching,
    } = useWeb3Contract({
        abi: abi,
        contractAddress: cryptocurrencyFutureBetAddress,
        ...
        <div className="p-5">
            ...
            <h1>
                ...
                <button
                    ...
                    disabled={WDisLoading || WDisFetching}
                >
                    {WDisLoading || WDisFetching ? (
                        <div className="animate-spin spinner-border h-8 w-8 border-b-2 rounded-full"></div>
                    ) : (
                        "Withdraw Margin"
                    )}
